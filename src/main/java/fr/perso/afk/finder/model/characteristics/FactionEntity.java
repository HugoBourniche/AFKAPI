...
public class FactionEntity {
    ...
    public static FactionEntity getFactionByName(String name) {
        switch(name) {
            ...
            case "Celestials"    : return FACTIONS.get(1);
            case "Hypogeans"     : return FACTIONS.get(2);
            case "Lightbearers"  : return FACTIONS.get(3);
            case "Graveborns"    : return FACTIONS.get(4);
            case "Wilders"       : return FACTIONS.get(5);
            case "Maulers"       : return FACTIONS.get(6);
